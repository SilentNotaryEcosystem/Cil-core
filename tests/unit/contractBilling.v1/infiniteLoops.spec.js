...
describe('Contract billing: Infinite loop breaking using loop iteration cost', () => {
    ...
    beforeEach(() => {
        ...
        app.setupVariables({
            coinsLimit: nFeeContractInvocation + 10000,
            objFees: {
    ...
    it('should throw an exception for the infinite loop: for (;;);', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({test: `()${billingCodeWrapper('{ for (;;); }', nContractBillingVersion)}`}),
            conciliumId: 10
        });
    ...
    it('should throw an exception for the infinite loop: for (;;) { continue; }', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper('{ for (;;) { continue; } }', nContractBillingVersion)}`
            }),
            conciliumId: 10
        });
    ...
    it('should throw an exception for the infinite loop: while (true);', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper('{ while (true); }', nContractBillingVersion)}`
            }),
            conciliumId: 10
        });
    ...
    it('should throw an exception for the infinite loop: while (true) { continue; }', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper('{ while (true) { continue; } }', nContractBillingVersion)}`
            }),
            conciliumId: 10
        });
    ...
    it('should throw an exception for the infinite loop: do ; while (true);', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper('{ do ; while (true); }', nContractBillingVersion)}`
            }),
            conciliumId: 10
        });
    ...
    it('should throw an exception for the infinite loop: do { continue; } while (true);', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper('{ do { continue; } while (true); }', nContractBillingVersion)}`
            }),
            conciliumId: 10
        });
    ...
    it('should throw an exception for the infinite recursion: function f() { f(); } f();', async () => {
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper('{ function f() { f(); } f(); }', nContractBillingVersion)}`
            }),
            conciliumId: 10
        });
        ...
        const contract = new factory.Contract({
            contractCode: JSON.stringify({
                test: `()${billingCodeWrapper(
                    '{ function f1() { f2(); } function f2() { f1(); } f1(); }',
