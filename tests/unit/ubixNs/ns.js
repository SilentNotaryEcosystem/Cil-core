...
class Ns extends Base {
    constructor() {
        ...
        this._ns = [];
        this._providers = new Set(['email', 'tg', 'ig']);
    ...
    addProvider(strProvider) {
        ...
        this._providers.add(strProvider);
    }
    ...
    removeProvider(strProvider) {
        ...
        this._providers.delete(strProvider);
    }
    ...
    _validateParameters(strProvider, strName, strAddress) {
        ...
        if (!this._providers.has(strProvider)) throw new Error('strProvider is not in the providers list');
    }
