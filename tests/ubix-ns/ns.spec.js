...
describe('Ubix NS', () => {
    ...
    describe('create Ubix NS record', async () => {
        ...
        beforeEach(async () => {
            ...
            strVerificationCode = 'test-code';
            // contract.getVeficationCode(...arrData);
        });
        ...
        it('should create', async () => {
            ...
            assert.deepEqual(await contract.resolve('mytestname'), [objData]);
        });
    ...
    describe('remove Ubix NS record', async () => {
        ...
        it('should remove', async () => {
            ...
            const strVerificationCode = 'test-code';
            // contract.getVeficationCode(...arrData);
    ...
    describe('resolve Ubix NS record', async () => {
        ...
        it('should resolve 2 records for the different providers', async () => {
            ...
            await contract.create(...arrDataNew, strVerificationCode);
