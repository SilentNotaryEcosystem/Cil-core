...
describe('Mempool tests', () => {
    ...
    it('should remove outdated bad TXns', async function() {
        ...
        const hashTx3 = pseudoRandomBuffer().toString('hex');
        const hashTx4 = pseudoRandomBuffer().toString('hex');
        ...
        assert.isNotOk(mempool.isBadTx(hashTx1));
        assert.isNotOk(mempool.isBadTx(hashTx3));
        assert.isNotOk(mempool.isBadTx(hashTx4));
    });
