...
describe('Conciliums', async () => {
    ...
    describe('ConciliumPoS', () => {
        ...
        it('should sort members from most staked', async () => {
            ...
            assert.deepEqual(concilium.getAddresses(false, true), [arrMembers[1].address, arrMembers[0].address]);
        });
        ...
        it('should keep original order', async () => {
            ...
            assert.deepEqual(concilium.getAddresses(false), [arrMembers[0].address, arrMembers[1].address]);
        });
