    ...
    return class MainDagIndex {
        ...
        _createRecord() {
            return {
                ...
                // won't use it, just for reference
        ...
        addBlock(blockInfo, arrParentBlocks, bIsTipBlock = false) {
            ...
            if ((nHeight === nHighestPageHeight || bIsTipBlock) && objPageData.insideHashes.size) {
